...
> Mis a jour: 2026-04-10. Engine: ~19K lignes, 14 fichiers. UI: ~4900 lignes (+5197 ref), 20 fichiers. Tests: 1617 collected, 0 FAIL ours.
...
>
> **Leak Intel Battle Plan (2026-04-10):** 5 chunks done (CHUNK 1-5).
> See CHANGELOG.md and docs/CLAUDE_CODE_LEAK_INTEL.md.
> Hooks: 4 -> 6 (UserPromptSubmit, PreCompact, SessionEnd, Stop, **PostToolUseFailure**, **SubagentStart**).
> CLAUDE.md refactored to XML compartments + sandwich + 8 RULES with negative examples.
...
### .claude/hooks/ — Generated Hook Handlers (4 files)
All generated by `install_hooks()` in `engine/core/muninn.py` and mirrored
