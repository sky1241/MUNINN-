...
> Mis a jour: 2026-04-17 (brick 25). Engine: ~19K lignes, 17 fichiers (+lexicons +dedup +budget_select). UI: ~4900 lignes (+5197 ref), 20 fichiers. Tests: **2190+ collected, PASS, 27 skip, 0 FAIL** post brick 25 (default suite, ignore 5 known-slow real-DB tests).
