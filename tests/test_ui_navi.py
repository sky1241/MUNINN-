...
2026-05-19 — Fix latent CI segfault in _paint_orb's QRadialGradient
layers. Le guard est maintenant dans navi.py:_paint_orb directement
(skip glow layers si CI=true et QT_QPA_PLATFORM=offscreen). Plus
besoin de skip toute la suite — les autres tests UI continuent de
valider le code path.
"""
