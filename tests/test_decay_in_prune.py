...
class TestDecayInPrune:
    ...
    def test_prune_calls_decay(self, tmp_path, monkeypatch):
        ...
        source = chr(10).join(_mdir.joinpath(f).read_text(encoding="utf-8") for f in ["muninn.py", "muninn_layers.py", "muninn_tree.py", "muninn_tree_boot.py", "muninn_tree_prune.py", "muninn_tree_doctor.py", "muninn_feed.py"])
