...
# H6 chunk 1 (2026-05-09): meta-mycelium federation extracted to its own
# mixin module. Same self attributes, same public API on Mycelium.
try:
...
class Mycelium(_MyceliumMetaMixin):
