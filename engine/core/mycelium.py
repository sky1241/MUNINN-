...
# H6 chunks 1-2 (2026-05-09): meta + zones extracted to their own mixin
# modules. Same self attributes, same public API on Mycelium. Mixed in
# via class Mycelium(_Mixin1, _Mixin2, ...).
try:
