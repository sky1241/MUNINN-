...
# H6 chunks 1-3 (2026-05-09): meta + zones + activation extracted to their
# own mixin modules. Same self attributes, same public API on Mycelium.
# Mixed in via class Mycelium(_Mixin1, _Mixin2, ...).
try:
...
class Mycelium(_MyceliumMetaMixin, _MyceliumZonesMixin, _MyceliumActivationMixin):
