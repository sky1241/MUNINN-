...
def gen_props(root, module_path, include_destructive=False):
    ...
    lines = [
        ...
        "# but it does not follow indirect calls. Hypothesis fuzz of a",
        "# path-like arg with a random string pollutes the repo root via",
        "# the indirect mkdir. This autouse fixture chdir's into tmp_path",
        "# so any indirect FS mutation lands in a pytest-managed sandbox.",
